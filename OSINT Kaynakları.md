...
- [Google Dorking Cheatsheet](https://gist.github.com/sundowndev/283efaddbcf896ab405488330d1bbc06#file-googledorking-md)
- [Google Hacking Database](https://www.exploit-db.com/google-hacking-database)
- [Shodan](https://www.shodan.io/)
- [Shodan Cheatsheet](https://book.martiandefense.llc/notes/security-research/shodan-dork-cheatsheet)
- [Google Advanced Search](https://www.google.com/advanced_search)
- [Twitter Dorking Cheatsheet](https://cheatsheet.haax.fr/open-source-intelligence-osint/dorks/twitter_dorks/)
- Bing
- Yandex
- DuckDuckGo
...
### Fotoğraflardan Meta Veri Okuma

- [Online Exiftool](https://exif.tools/)

### Alan Adı Kayıtları

- [whois lookup](https://lookup.icann.org/en)
- [crt.sh](https://crt.sh)
